...
export const verticalMenuItems = [
    ...
    new Menu (55, 'Lịch hẹn', '/schedule', null, 'fa-solid fa-house', null, false, 0),
    new Menu (2, 'Bác sĩ/Nhân viên', '/users', null, 'fa-solid fa-house', null, false, 0), 
    new Menu (86, 'Dụng cụ/Vật liệu', '/equipment', null, 'fa-solid fa-house', null, false, 0),   
    new Menu (3, 'UI Features', null, null, 'fa-solid fa-house', null, true, 0),   
    new Menu (4, 'Buttons', '/ui/buttons', null, 'fa-solid fa-house', null, false, 3),  
    new Menu (5, 'Cards', '/ui/cards', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (6, 'Lists', '/ui/lists', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (7, 'Grids', '/ui/grids', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (8, 'Tabs', '/ui/tabs', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (9, 'Expansion Panel', '/ui/expansion-panel', null, 'fa-solid fa-house', null, false, 3),
    new Menu (10, 'Chips', '/ui/chips', null, 'fa-solid fa-house', null, false, 3),
    new Menu (11, 'Progress', '/ui/progress', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (12, 'Dialog', '/ui/dialog', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (13, 'Tooltip', '/ui/tooltip', null, 'fa-solid fa-house', null, false, 3), 
    new Menu (14, 'Snackbar', '/ui/snack-bar', null, 'fa-solid fa-house', null, false, 3), 
